...
var profileImg = $('.blog-area img.d-block'); // Target profile image
var uploadBtn = $('.btn-primary').filter(function() {
    return $(this).text().trim() === "Upload";
});
var removeBtn = $('.btn-soft-primary').filter(function() {
...
removeBtn.on('click', function(e) {
    e.preventDefault();
    profileImg.attr('src', 'img/test-img/1.jpg'); // Put your default image path here
